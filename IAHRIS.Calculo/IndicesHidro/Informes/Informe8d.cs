...
{
    public class Informe8d : Informe
    {
        public Informe8d(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
