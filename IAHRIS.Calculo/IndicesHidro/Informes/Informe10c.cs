...
{
    public class Informe10c : Informe
    {
        public Informe10c(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
