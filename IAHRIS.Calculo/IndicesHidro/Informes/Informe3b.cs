...
{
    public class Informe3b : Informe
    {
        public Informe3b(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
