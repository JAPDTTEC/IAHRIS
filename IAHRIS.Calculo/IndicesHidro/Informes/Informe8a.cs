...
{
    public class Informe8a : Informe
    {
        public Informe8a(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
