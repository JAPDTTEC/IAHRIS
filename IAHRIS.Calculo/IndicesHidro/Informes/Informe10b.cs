...
{
    public class Informe10b : Informe
    {
        public Informe10b(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
