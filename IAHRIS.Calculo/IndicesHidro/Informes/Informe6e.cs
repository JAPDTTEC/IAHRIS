...
{
    public class Informe6e : Informe
    {
        public Informe6e(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
