...
{
    public class Informe7b : Informe
    {
        public Informe7b(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
        ...
        public override void Escribir(ExcelPackage excel, ref DatosCalculo datos,  ref IAHRISDataSet dataset, MultiIdiomasXML traductor)
        {
            ...
            if (dataset._IndicesHabituales[0].calculado)
            {
                ...
                offsetRow = 21;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[1]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[1]) + "22"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[1]) + "22"].Value = null;
                ...
                offsetRow = 26;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[2]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[2]) + "27"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[2]) + "27"].Value = null;
                ...
                offsetRow = 31;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[3]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[3]) + "32"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[0].valor[3]) + "32"].Value = null;
            ...
            if (dataset._IndicesHabituales[1].calculado)
            {
                ...
                offsetRow = 22;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[1]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[1]) + "23"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[1]) + "23"].Value = null;
                ...
                offsetRow = 27;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[2]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[2]) + "28"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[2]) + "28"].Value = null;
                ...
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[3]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[3]) + "33"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[1].valor[3]) + "33"].Value = null;
            ...
            {
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[0]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[0]) + "19"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[0]) + "19"].Value = null;
                ...
                offsetRow = 23;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[1]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[1]) + "24"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[1]) + "24"].Value = null;
                ...
                offsetRow = 28;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[2]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[2]) + "29"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[2]) + "29"].Value = null;
                ...
                offsetRow = 33;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[3]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[3]) + "34"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[3].valor[3]) + "34"].Value = null;
            ...
            {
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[0]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[0]) + "20"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[0]) + "20"].Value = null;
                objSheet.Cells[offsetRow + 1, offsetCol + 1].Value = dataset._IndicesHabituales[5].valor[0];

                offsetRow = 24;
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[1]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[1]) + "25"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[1]) + "25"].Value = null;
                objSheet.Cells[offsetRow + 1, offsetCol + 1].Value = dataset._IndicesHabituales[5].valor[1];

                offsetRow = 29;
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[2]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[2]) + "30"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[2]) + "30"].Value = null;
                objSheet.Cells[offsetRow + 1, offsetCol + 1].Value = dataset._IndicesHabituales[5].valor[2];

                offsetRow = 34;
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[3]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[3]) + "35"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[5].valor[3]) + "35"].Value = null;
            ...
            {
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[0]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[0]) + "21"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[0]) + "21"].Value = null;

                objSheet.Cells[offsetRow + 1, offsetCol + 1].Value = dataset._IndicesHabituales[6].valor[0];
                offsetRow = 25;
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[1]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[1]) + "26"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[1]) + "26"].Value = null;

                objSheet.Cells[offsetRow + 1, offsetCol + 1].Value = dataset._IndicesHabituales[6].valor[1];
                offsetRow = 30;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[2]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[2]) + "31"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[2]) + "31"].Value = null;


                objSheet.Cells[offsetRow + 1, offsetCol + 1].Value = dataset._IndicesHabituales[6].valor[2];
                offsetRow = 35;
                s = "";
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[3]) + "16"].Copy(objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[3]) + "36"]);
                objSheet.Cells[DarColumna(dataset._IndicesHabituales[6].valor[3]) + "36"].Value = null;
