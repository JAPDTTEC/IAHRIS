...
{
    public class Informe6b : Informe
    {
        public Informe6b(bool active, int index, string nombreInformeXML, string nombrePestaña) : base(active, index, nombreInformeXML, nombrePestaña)
        {
        }
