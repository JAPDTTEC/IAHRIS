    ...
    public class OleDbDataBase
    {
        ...
        private OleDbConnection GetNuevaConexion()
        {
            ...
            try
            {
                ...
                //connectionString = "Provider=Microsoft.Jet.OLEDB.4.0; Locale Identifier=ES-es; Data Source=" + _rutaMDB;
        ...
        public bool InsertarRegistro(string NombreTabla, string[] Campos, string[] Valores)
        {
            ...
            try
            {
                ...
                Ds.Locale = new System.Globalization.CultureInfo("es-ES");
        ...
        public bool CompactarBD()
        {
            try
            {
                DBUtils.DataBaseUtils.CompactAccessDB("Base", _rutaMDB);
            }
            catch (Exception ex)
            {
                throw ex;
