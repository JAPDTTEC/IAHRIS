...
namespace IAHRIS.Calculo
{
    public class TestFechas
    {
        ...
        public struct Simulacion
        {
            ...
            public string nombreRegimenPunto;
            public string abreviaturaRegimenPunto;
            public string nombreRegimenAlteracion;
            public string abreviaturaRegimenAlteracion;

        }
        public struct InfInfo
        {
            public InfInfo(int index)
            {
                Active = false;
                Index = index;
            }
        ...
        {
            public GeneracionInformes(bool dummy)
            {
                inf1 = new InfInfo(1);
                inf1a = new InfInfo(3);
                inf1b = new InfInfo(5);
                ...
                inf3 = new InfInfo(8);
                inf3a = new InfInfo(9);
                inf3b = new InfInfo(10);
                inf4 = new InfInfo(13);
                inf4a = new InfInfo(15);
                inf5 = new InfInfo(17);
                inf5a = new InfInfo(19);
                inf5b = new InfInfo(21);
                inf6 = new InfInfo(23);
                inf6a = new InfInfo(24);
                inf6b = new InfInfo(25);
                inf6c = new InfInfo(26);
                inf6d = new InfInfo(27);
                inf6e = new InfInfo(28);
                inf7a = new InfInfo(29);
                inf7b = new InfInfo(30);
                inf7c = new InfInfo(31);
                inf7d = new InfInfo(32);
                inf8 = new InfInfo(33);
                inf8a = new InfInfo(34);
                inf8b = new InfInfo(35);
                inf8c = new InfInfo(36);
                inf8d = new InfInfo(37);
                inf9 = new InfInfo(38);
                inf9a = new InfInfo(39);
                inf9b = new InfInfo(40);
                inf10a = new InfInfo(41);
                inf10b = new InfInfo(42);
                inf10c = new InfInfo(43);
                inf10d = new InfInfo(44);
            }

            public InfInfo inf1;
            public InfInfo inf1a;
            public InfInfo inf1b;
            public InfInfo inf2;
            public InfInfo inf2a;
            public InfInfo inf3;
            public InfInfo inf3a;
            public InfInfo inf3b;
            public InfInfo inf4;
            public InfInfo inf4a;
            //public bool inf4b; // Nuevo 12/4/10
            public InfInfo inf5;
            public InfInfo inf5a;
            public InfInfo inf5b;
            public InfInfo inf6;
            public InfInfo inf6a;
            public InfInfo inf6b;
            public InfInfo inf6c;
            public InfInfo inf6d;
            public InfInfo inf6e;
            public InfInfo inf7a;
            public InfInfo inf7b;
            public InfInfo inf7c;
            public InfInfo inf7d;
            public InfInfo inf8;
            public InfInfo inf8a; // Nuevo 12/4/10
            public InfInfo inf8b; // Nuevo 12/4/10
            public InfInfo inf8c; // Nuevo 12/4/10
            public InfInfo inf8d; // Nuevo 12/4/10
            public InfInfo inf9;
            public InfInfo inf9a; // Nuevo 12/4/10
            public InfInfo inf9b;
            public InfInfo inf10a;
            public InfInfo inf10b;
            public InfInfo inf10c;
            public InfInfo inf10d;
        }
        ...
        public EstadoLista TestMesAño(string tabla, string campo, DateTime fechaInicial, DateTime fechaFinal, int idlista)
        {
            ...
            for (i = 0; i <= loopTo; i++)
            {
                ...
                DataSet ds = _cMDB.RellenarDataSet("tabla", sSQL);
        ...
        public Coetaneidad CalcularCoetaneidad(EstadoLista l1, EstadoLista l2, int[] interNat, int[] interAlt)
        {
            Coetaneidad salida;
            int i;
        ...
        public Coetaneidad CalcularCoetaniedad(int idPunto)
        {
