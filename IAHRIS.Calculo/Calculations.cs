...
namespace IAHRIS.Calculo
{
    public class Calculations
    {
        ...
        public void CalculoParametrosAvenidasAlteradosCASO6()
        {
            ...
            //JAPD-18/10/2023
            //El IAH9 usa un valor peculiar de Periodo de retorno. 
            //El valor se calcula en este punto porque es donde disponemos de todos los valores, 
            //pero lo guardamos en una variable específica para ello que no afecte el 
            //Periodo de retorno de alterado, que no se usaba en versiones anteriores, pero si se usa ahora
            //
        ...
        public void CalcularIndicesHabitualesAgregados()
        {
            ...
            if (_dataSet._HabMagnitudAlt.Length > 1)
            {
            ...
            acum = 0f;
            var numAñosNat = _dataSet._AportacionNatAnual.aportacion.Length - 1;
            for (i = 0; i <= numAñosNat; i++)
            {
                for (j = 0; j <= 11; j++)
            ...
            for (i = 0; i <= 11; i++)
                mediasMesNat[i] = mediasMesNat[i] / (numAñosNat + 1);
            var numAñosAlt = _dataSet._AportacionAltAnual.aportacion.Length - 1;
            for (i = 0; i <= numAñosAlt; i++)
            {
                for (j = 0; j <= 11; j++)
            ...
            for (i = 0; i <= 11; i++)
                mediasMesAlt[i] = mediasMesAlt[i] / (numAñosAlt + 1);
            ...
            var desviacionMesNat = new double[12];
            var desviacionMesAlt = new double[12];
            var CVMesNat = new float[12];
            var CVMesAlt = new float[12];
            var auxLista1 = new double[12][];
            ...
            for (i = 0; i <= loopTo4; i++)
            {
                ...
                for (j = 0; j <= 11; j++)
                {
                    auxLista1[j][i] = _dataSet._AportacionNatMen.aportacion[i * 12 + j];
                }
            }
            ...
            for (i = 0; i <= loopTo5; i++)
            {
                for (j = 0; j <= 11; j++)
                {
                    auxLista1[j][i] = _dataSet._AportacionAltMen.aportacion[i * 12 + j];
                }
            }
            ...
            for (i = 0; i <= 11; i++)
            {
                CVMesNat[i] =(float)( desviacionMesNat[i]);
                CVMesAlt[i] = (float)(desviacionMesAlt[i]);
            }
            ...
            if (_dataSet._HabVariabilidadAlt.Length > 1) 
            { 
        ...
        public void CalcularIndicesAvenidasCASO6()
        {
            ...
            //JAPD 18/10/2023 - Se usa el nuevo valor _Ave2TAltIAH9 para calcular el IAH9 porque tiene particularidades específicas y es mas simple calcularlo en la función
            ...
            if (_dataSet._Ave2TAltIAH9 == 0f & _dataSet._Ave2TNat == 0f)
            {
                _dataSet._IndicesAvenidas[2].valor[0] = 1f;
                _dataSet._IndicesAvenidas[2].indeterminacion[0] = true;
            }
            else if (_dataSet._Ave2TAltIAH9 != 0f & _dataSet._Ave2TNat == 0f)
            {
                _dataSet._IndicesAvenidas[2].valor[0] = 0f;
                _dataSet._IndicesAvenidas[2].indeterminacion[0] = true;
            }
            else if (_dataSet._Ave2TAltIAH9 > _dataSet._Ave2TNat)
            {
                _dataSet._IndicesAvenidas[2].valor[0] = _dataSet._Ave2TNat / _dataSet._Ave2TAltIAH9;
                _dataSet._IndicesAvenidas[2].invertido[0] = true;
            }
            else
            {
                _dataSet._IndicesAvenidas[2].valor[0] = _dataSet._Ave2TAltIAH9 / _dataSet._Ave2TNat;
            }
